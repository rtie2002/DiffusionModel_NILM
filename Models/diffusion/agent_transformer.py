...
class FourierLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        # SPEED OPTIMIZATION: Move to float32 for FFT to avoid slow ComplexHalf kernels
        # This fixes the "ComplexHalf support is experimental" warning and speeds up training.
        x_f32 = x.float()
        ...
        res = self.extrapolate(x_freq, f, t)
        return res.to(x.dtype) # Cast back to original precision (e.g., FP16)

    def extrapolate(self, x_freq, f, t):
        # Continue in float32 for precision and speed in trig functions
